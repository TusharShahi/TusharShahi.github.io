export const displayPictureLink =
  "/images/displayPicture-experience-desktop.jpg";
export const displayPictureLinkPhone =
  "/images/displayPicture-experience-phone.jpg";

export const socialMediaIconLink =
  "/images/icons/socialMediaIcon-instagram.svg";
...
export const myDescription =
  "Software Engineer based out of Delhi who enjoys product development. Has experience working at an early stage startup as well as a Fortune 500 company.";
...
export const workFlixRemote = {
  ...
  mockup: "/images/work/desktop/flixremote-mockup.png",
...
export const workMRMWebsite = {
  ...
  mockup: "/images/work/desktop/mrmwebsite-mockup.png",
...
export const workEmergencyZone = {
  ...
  mockup: "/images/work/desktop/emergencyzone-mockup.png",
...
export const experienceRMO = {
  ...
  description:
    "Built online review analysis tool. Enhanced existing product dashboard with more insightful data analysis features. Created influencer discovery platform from scratch. Mentored interns to successfully onboard them to the project.",
  timePeriod: "December 2018 - June 2019",
  skillsUsed: [
    /*{ 'name' : 'Stanford Core NLP' , 'imageLink' : 'stanfordCoreNLP'},*/
    skills["es"],
    skills["mongo"],
    skills["typescript"],
    skills["python"]
...
export const experienceRMO2 = {
  ...
  company: "Rank Me Online",
  description:
    "Built the new product dashboard of the B2B Online Reputation Management tool. The dashboard provided efficient searching, filtering, and aggregations of social media data.",
  timePeriod: "June 2018 - July 2018",
  skillsUsed: [skills["es"], skills["typescript"]]
};
...
export const experienceMRM = {
  ...
  description:
    "Handled finance, sponsorship, public relations, social media and other documentation. Ensured smooth working of the team. Mentored juniors to take on same role.",
...
export const experienceTCFG = {
  ...
  description:
    "Volunteered as an HTML and Python teacher in schools in proximity. Went on to design the curriculum for the same.",
